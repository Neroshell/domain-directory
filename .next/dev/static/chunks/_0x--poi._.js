...
function Page() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$domain$2d$directory$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
        fileName: "[project]/app/page.tsx",
        lineNumber: 44,
        columnNumber: 10
    }, this);
}
_s(Page, "QNmoMfrDQTZawVsGT/oU4aUcARg=", false, function() {
    return [
...
function CsvImportDialog({ existing, onClose, onImported }) {
    ...
    async function importChanges() {
        ...
        setBusy(true);
        try {
            const { data: { user }, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
            ...
            const newRows = summary.newItems.flatMap((item)=>item.record ? [
                    {
            ...
            for(let index = 0; index < newRows.length; index += batchSize){
                const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('domains').insert(newRows.slice(index, index + batchSize));
            ...
            for(let index = 0; index < changedRows.length; index += batchSize){
                ...
                const updateResults = await Promise.all(updateBatch.map(({ id, ...changes })=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('domains').update(changes).eq('id', id)));
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ResultStat, {
                                    label: "Skipped",
                                    value: (summary?.unchangedItems.length ?? 0) + (summary?.duplicateItems.length ?? 0) + (summary?.invalidItems.length ?? 0)
                                }, void 0, false, {
                                    fileName: "[project]/components/csv-import-dialog.tsx",
                                    lineNumber: 109,
                                    columnNumber: 182
...
function DomainDirectory() {
    ...
    async function loadDomains() {
        ...
        let offset = 0;
        while(true){
            const { data, error: requestError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["publicSupabase"].from('domains').select('*').order('domain', {
                ascending: true
...
//# sourceMappingURL=_0x--poi._.js.map