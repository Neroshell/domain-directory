...
function LoginPage() {
    ...
    async function handleGoogleSignIn() {
        setError(null);
        setLoading(true);
        const { error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOAuth({
            provider: 'google',
            options: {
...
//# sourceMappingURL=_0fiiu0o._.js.map